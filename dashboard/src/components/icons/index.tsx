...
export const StellarLogo = ({ className = "w-8 h-8" }: IconProps) => (
  <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="50" fill="url(#stellar-gradient)" />
    <path d="M70.5 35.5L29.5 52.5V58L70.5 41V35.5Z" fill="white" />
    <path d="M70.5 46L29.5 63V68.5L70.5 51.5V46Z" fill="white" />
    <path d="M29.5 35.5L23 38.5V44L70.5 24V18.5L29.5 35.5Z" fill="white" />
    <path d="M77 56L70.5 59V64.5L77 61.5V56Z" fill="white" />
    <defs>
      <linearGradient id="stellar-gradient" x1="0" y1="0" x2="100" y2="100">
        <stop stopColor="#08B5E5" />
        <stop offset="1" stopColor="#0E76FD" />
      </linearGradient>
    </defs>
  </svg>
);
